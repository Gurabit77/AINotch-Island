...
private enum FileTrayStorage {
    ...
    static func deleteIfStoredInTray(_ url: URL) {
        ...
        do {
            ...
            AppLogger.general.error("Failed to delete File Tray copy: \(error.localizedDescription)")
        }
    }
    ...
    static func trashIfStoredInTray(_ url: URL) {
        ...
        do {
            ...
            AppLogger.general.error("Failed to move File Tray item to Trash: \(error.localizedDescription)")
        }
    }
