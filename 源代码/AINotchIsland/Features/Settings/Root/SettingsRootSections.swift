...
private enum SettingsSectionCatalog {
    ...
    static func sectionDescriptor(
        ...
        case .agentHalo:
            return .init(
                sidebarGroup: .app,
                titleKey: "settings.section.agentHalo.title",
                fallbackTitle: "AINotchIsland",
                subtitleKey: "settings.section.agentHalo.subtitle",
                fallbackSubtitle: "AI agent monitoring, extensions, and terminal jump.",
                searchKeywords: [
                    "agent",
                    "halo",
                    "ai",
        ...
        case .debug:
            return .init(
                sidebarGroup: .app,
                titleKey: "settings.section.showcase.title",
                fallbackTitle: "Showcase",
                subtitleKey: "settings.section.showcase.subtitle",
                fallbackSubtitle: "Run a guided tour of every island scene — great for demos and recording.",
                searchKeywords: [
                    "preview",
                    "demo",
                    "showcase",
