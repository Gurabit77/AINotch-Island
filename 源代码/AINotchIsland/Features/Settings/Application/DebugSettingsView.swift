...
struct DebugSettingsView: View {
    ...
    private var persistentPreviewsCard: some View {
        SettingsCard(title: L10n.appKey("settings.debug.persistentEvents", fallback: "Persistent Events")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.onboarding.title", fallback: "Onboarding"),
                description: L10n.appKey("settings.debug.onboarding.description", fallback: "Show a safe debug preview of the onboarding live activity."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.focusOn.title", fallback: "Focus On"),
                description: L10n.appKey("settings.debug.focusOn.description", fallback: "Preview the persistent Focus live activity."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.screenRecording.title", fallback: "Screen Recording"),
                description: L10n.appKey("settings.debug.screenRecording.description", fallback: "Preview the persistent screen recording indicator."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.hotspotActive.title", fallback: "Hotspot Active"),
                description: L10n.appKey("settings.debug.hotspotActive.description", fallback: "Keep the hotspot live activity visible until you turn it off."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.nowPlaying.title", fallback: "Now Playing"),
                description: L10n.appKey("settings.debug.nowPlaying.description", fallback: "Show the music live activity with sample track data."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.downloads.title", fallback: "Downloads"),
                description: L10n.appKey("settings.debug.downloads.description", fallback: "Show the download live activity with sample transfer data."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.timer.title", fallback: "Timer"),
                description: L10n.appKey("settings.debug.timer.description", fallback: "Show the timer live activity with sample transfer data."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.fileTray.title", fallback: "File Tray Active"),
                description: L10n.appKey("settings.debug.fileTray.description", fallback: "Show the active tray live activity with sample files."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.fileConverter.title", fallback: "File Converter Active"),
                description: L10n.appKey("settings.debug.fileConverter.description", fallback: "Show the converter live activity with a sample image."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.debug.lockScreen.title", fallback: "Lock Screen"),
                description: L10n.appKey("settings.debug.lockScreen.description", fallback: "Preview the lock live activity without actually locking macOS."),
    ...
    private var triggerEventsCard: some View {
        SettingsCard(title: L10n.appKey("settings.debug.triggerEvents", fallback: "Trigger Events")) {
            DebugActionRow(
                title: "Run Full Showcase",
                description: "Plays every island scene paired with the matching buddy reaction, then a buddy-only tour of remaining animations. Great for recording feature demos.",
    ...
    private var utilitiesCard: some View {
        SettingsCard(title: L10n.appKey("settings.debug.utilities", fallback: "Utilities")) {
            DebugActionRow(
