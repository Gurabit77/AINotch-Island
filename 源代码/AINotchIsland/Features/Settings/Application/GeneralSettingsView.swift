...
struct GeneralSettingsView: View {
    ...
    private var systemCard: some View {
        SettingsCard(title: L10n.appKey("settings.general.system", fallback: "System")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.general.launchAtLogin.title", fallback: "Launch at login"),
                description: L10n.appKey("settings.general.launchAtLogin.description", fallback: "Launch Dynamic Notch automatically when you sign in."),
                systemImage: "power",
                color: .red,
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.general.dockIcon.title", fallback: "Show Dock icon"),
                description: L10n.appKey("settings.general.dockIcon.description", fallback: "Keep the app visible in the Dock for faster switching and window access."),
            ...
            VStack(alignment: .leading, spacing: 14) {
                SettingsToggleRow(
                    title: L10n.appKey("settings.general.menuBarIcon.title", fallback: "Show menu bar icon"),
                    description: L10n.appKey("settings.general.menuBarIcon.description", fallback: "Show a menu bar shortcut for quick access to Settings and Quit."),
                ...
                if !applicationSettings.isMenuBarIconVisible {
                    HStack {
                        ...
                        Text(L10n.app("settings.general.menuBarIcon.warning", fallback: "You can access the menu by right-clicking on the notch area."))
                            .font(.system(size: 10))
    ...
    private var themeCard: some View {
        SettingsCard(title: L10n.appKey("settings.general.appearance", fallback: "Appearance")) {
            CustomPicker(
                selection: $applicationSettings.appearanceMode,
                options: Array(SettingsAppearanceMode.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.general.theme.title", fallback: "Theme"),
                headerDescription: L10n.appKey("settings.general.theme.description", fallback: "Choose the interface appearance used by the app."),
                itemHeight: 110,
    ...
    private var displayCard: some View {
        SettingsCard(title: L10n.appKey("settings.general.location", fallback: "Location")) {
            CustomPicker(
                selection: $applicationSettings.displayLocation,
                options: Array(NotchDisplayLocation.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.general.display.title", fallback: "Display"),
                headerDescription: L10n.appKey("settings.general.display.description", fallback: "Choose which display Dynamic Notch should use."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.general.hideFullscreen.title", fallback: "Hide live activity in full-screen mode"),
                description: L10n.appKey("settings.general.hideFullscreen.description", fallback: "Automatically hide live activity while the selected display is showing a full-screen space."),
    ...
    private var languageCard: some View {
        SettingsCard(title: L10n.appKey("settings.general.localization", fallback: "Localization")) {
            VStack(alignment: .leading, spacing: 12) {
                AdaptiveCustomPicker(
                    selection: $applicationSettings.appLanguage,
                    options: Array(AINotchIslandLanguage.allCases),
                    headerTitle: L10n.appKey("settings.general.language.title", fallback: "Language"),
                    headerDescription: L10n.appKey("settings.general.language.description", fallback: "Choose the language used by the app interface."),
                    minimumItemWidth: 88,
