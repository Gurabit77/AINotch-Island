...
struct BluetoothSettingsView: View {
    ...
    private var bluetoothActivity: some View {
        SettingsCard(title: L10n.appKey("settings.bluetooth.activity", fallback: "Bluetooth activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.bluetooth.temporaryActivity.title", fallback: "Bluetooth temporary activity"),
                description: L10n.appKey("settings.bluetooth.temporaryActivity.description", fallback: "Show a temporary activity when a Bluetooth accessory connects."),
    ...
    private var bluetoothDuration: some View {
        SettingsCard(title: L10n.appKey("settings.bluetooth.duration", fallback: "Bluetooth duration")) {
            SettingsSliderRow(
                title: L10n.appKey("settings.bluetooth.durationSlider.title", fallback: "Bluetooth duration"),
                description: L10n.appKey("settings.bluetooth.durationSlider.description", fallback: "Choose how long the Bluetooth connection notification stays visible."),
    ...
    private var bluetoothAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.bluetooth.appearance", fallback: "Bluetooth appearance")) {
            CustomPicker(
                selection: $settings.bluetoothAppearanceStyle,
                options: Array(BluetoothAppearanceStyle.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.bluetooth.style.title", fallback: "Bluetooth style"),
                headerDescription: L10n.appKey("settings.bluetooth.style.description", fallback: "Choose between a device-focused layout or full device details."),
                itemHeight: 72,
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.bluetooth.batteryIndicator.title", fallback: "Battery indicator"),
                description: L10n.appKey("settings.bluetooth.batteryIndicator.description", fallback: "Choose whether Bluetooth battery information is shown as a percentage or a circular indicator."),
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.bluetooth.batteryStroke.title", fallback: "Battery-colored stroke"),
                description: L10n.appKey("settings.bluetooth.batteryStroke.description", fallback: "Tint Bluetooth battery styles using the current battery level color."),
