...
struct BatterySettingsView: View {
    ...
    private var batteryActivity: some View {
        SettingsCard(title: L10n.appKey("settings.battery.activity", fallback: "Battery activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.battery.charging.title", fallback: "Charging"),
                description: L10n.appKey("settings.battery.charging.description", fallback: "Show a temporary activity when your Mac starts charging."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.battery.lowPower.title", fallback: "Low Power"),
                description: L10n.appKey("settings.battery.lowPower.description", fallback: "Show a warning when Low Power Mode is enabled or the battery is critically low."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.battery.fullyCharged.title", fallback: "Fully Charged"),
                description: L10n.appKey("settings.battery.fullyCharged.description", fallback: "Show a temporary activity when the battery reaches the selected full charge level."),
    ...
    private var batteryDuration: some View {
        SettingsCard(title: L10n.appKey("settings.battery.duration", fallback: "Battery duration")) {
            SettingsSliderRow(
                title: L10n.appKey("settings.battery.chargingDuration.title", fallback: "Charging duration"),
                description: L10n.appKey("settings.battery.chargingDuration.description", fallback: "Choose how long the charging notification stays visible."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.battery.lowDuration.title", fallback: "Low battery duration"),
                description: L10n.appKey("settings.battery.lowDuration.description", fallback: "Choose how long the low battery notification stays visible."),
                range: temporaryActivityDurationRange,
                step: 1,
                fractionLength: 0,
                suffix: "s",
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.battery.fullDuration.title", fallback: "Full battery duration"),
                description: L10n.appKey("settings.battery.fullDuration.description", fallback: "Choose how long the full battery notification stays visible."),
                range: temporaryActivityDurationRange,
                step: 1,
                fractionLength: 0,
                suffix: "s",
    ...
    private var lowBattery: some View {
        SettingsCard(title: L10n.appKey("settings.battery.lowBattery", fallback: "Low battery")) {
            CustomPicker(
                selection: $batterySettings.lowPowerStyle,
                options: Array(BatteryNotificationStyle.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.battery.lowStyle.title", fallback: "Low battery style"),
                headerDescription: L10n.appKey("settings.battery.lowStyle.description", fallback: "Choose whether the alert uses the current detailed card or a compact charging-like layout."),
                itemHeight: 82,
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.battery.lowDefaultStroke.title", fallback: "Default stroke"),
                description: L10n.appKey("settings.battery.lowDefaultStroke.description", fallback: "Use the standard white notch stroke instead of the low battery alert color."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.battery.lowThreshold.title", fallback: "Low battery threshold"),
                description: L10n.appKey("settings.battery.lowThreshold.description", fallback: "Choose the battery percentage that triggers the low battery notification."),
    ...
    private var fullBattery: some View {
        SettingsCard(title: L10n.appKey("settings.battery.fullBattery", fallback: "Full battery")) {
            CustomPicker(
                selection: $batterySettings.fullPowerStyle,
                options: Array(BatteryNotificationStyle.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.battery.fullStyle.title", fallback: "Full battery style"),
                headerDescription: L10n.appKey("settings.battery.fullStyle.description", fallback: "Choose whether the alert uses the current detailed card or a compact charging-like layout."),
                itemHeight: 82,
                lightBackgroundImage: Image("backgroundLight"),
                darkBackgroundImage: Image("backgroundDark")
            ) { style, isSelected in
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.battery.fullDefaultStroke.title", fallback: "Default stroke"),
                description: L10n.appKey("settings.battery.fullDefaultStroke.description", fallback: "Use the standard white notch stroke instead of the full battery alert color."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.battery.fullThreshold.title", fallback: "Full charge threshold"),
                description: L10n.appKey("settings.battery.fullThreshold.description", fallback: "Choose the battery percentage that triggers the full charge notification."),
