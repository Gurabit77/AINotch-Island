...
struct FullPowerNotchView: View {
    ...
    var body: some View {
        Group {
            if style == .compact {
                HStack(spacing: 8) {
                    CrabReactionView(scene: .fullBattery, pixelSize: 3.0)
                        .scaleEffect(0.75)
                    BatteryCompactStatusView(
                        title: L10n.app("notch.battery.fullBattery", fallback: "Full Battery"),
    ...
    private var title: some View {
        HStack {
            Text(L10n.app("notch.battery.fullBattery", fallback: "Full Battery"))
                .font(.system(size: 13))
    ...
    private var description: some View {
        Text(L10n.app("notch.battery.fullyCharged", fallback: "Your Mac is fully charged."))
            .font(.system(size: 10))
