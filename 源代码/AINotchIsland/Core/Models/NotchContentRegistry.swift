...
enum NotchContentPriority {
    ...
    static let agentHalo = 8
    static let agentHaloApproval = 9
...
enum NotchContentRegistry {
    ...
    enum AgentHalo {
        static let active = NotchContentDescriptor(
            id: "agentHalo.active",
            priority: NotchContentPriority.agentHalo
        )
        static let approval = NotchContentDescriptor(
            id: "agentHalo.approval",
            priority: NotchContentPriority.agentHaloApproval
        )
    }

    enum ExternalDrive {
        static let connected = NotchContentDescriptor(id: "externalDrive.connected")
        static let ejected = NotchContentDescriptor(id: "externalDrive.ejected")
    }

    enum Buddy {
        static let idle = NotchContentDescriptor(id: "buddy.idle")
        static let alwaysOn = NotchContentDescriptor(
            id: "buddy.alwaysOn",
            priority: NotchContentPriority.default
        )
    }
