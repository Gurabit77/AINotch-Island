    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading, spacing: 5) {
                Text(L10n.app("notch.onboarding.telegramChannel", fallback: "Telegram channel"))
                    .font(.system(size: 16, weight: .semibold))
                    .foregroundColor(.white)
                    .lineLimit(1)

                Text(L10n.app("notch.onboarding.telegramDesc", fallback: "Join the Telegram channel to stay up-to-date with new updates."))
