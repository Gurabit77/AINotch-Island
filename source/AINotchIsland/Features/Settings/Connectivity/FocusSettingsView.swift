...
struct FocusSettingsView: View {
    ...
    private var focusActivity: some View {
        SettingsCard(title: L10n.appKey("settings.focus.activity", fallback: "Focus activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.focus.liveActivity.title", fallback: "Focus live activity"),
                description: L10n.appKey("settings.focus.liveActivity.description", fallback: "Show a live activity while Focus mode is enabled."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.focus.offActivity.title", fallback: "Focus off activity"),
                description: L10n.appKey("settings.focus.offActivity.description", fallback: "Show a short notification when Focus mode turns off."),
    ...
    private var focusDuration: some View {
        SettingsCard(title: L10n.appKey("settings.focus.duration", fallback: "Focus duration")) {
            SettingsSliderRow(
                title: L10n.appKey("settings.focus.offDuration.title", fallback: "Focus off duration"),
                description: L10n.appKey("settings.focus.offDuration.description", fallback: "Choose how long the Focus off notification stays visible."),
    ...
    private var focusAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.focus.appearance", fallback: "Focus appearance")) {
            CustomPicker(
                selection: $connectivitySettings.focusAppearanceStyle,
                options: Array(FocusAppearanceStyle.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.focus.style.title", fallback: "Focus style"),
                headerDescription: L10n.appKey("settings.focus.style.description", fallback: "Choose whether Focus shows the On and Off labels or only the moon icon."),
                itemHeight: 72,
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.focus.defaultStroke.title", fallback: "Default stroke"),
                description: L10n.appKey("settings.focus.defaultStroke.description", fallback: "Use the standard white notch stroke instead of the Focus accent stroke."),
