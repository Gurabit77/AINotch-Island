...
struct LockScreenSettingsView: View {
    ...
    private var lockScreenActivity: some View {
        SettingsCard(title: L10n.appKey("settings.lockScreen.activity", fallback: "Lock screen activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.lockScreen.liveActivity.title", fallback: "Lock screen live activity"),
                description: L10n.appKey("settings.lockScreen.liveActivity.description", fallback: "Show the lock-screen live activity during lock and unlock transitions."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.lockScreen.mediaPanel.title", fallback: "Lock screen media panel"),
                description: L10n.appKey("settings.lockScreen.mediaPanel.description", fallback: "Show the detached media panel on the lock screen while playback is active."),
    ...
    private var notchAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.lockScreen.notchAppearance", fallback: "Notch appearance")) {
            CustomPicker(
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.lockScreen.sound.title", fallback: "Lock screen sound"),
                description: L10n.appKey("settings.lockScreen.sound.description", fallback: "Play a sound when locking or unlocking your Mac."),
    ...
    private var artworkAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.lockScreen.artworkAppearance", fallback: "Artwork appearance")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.lockScreen.lyrics.title", fallback: "Lock screen lyrics"),
                description: L10n.appKey("settings.lockScreen.lyrics.description", fallback: "Show synced lyrics next to the track cover when artwork is opened."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.lockScreen.mediaPanelBackground.title", fallback: "Media panel background"),
                description: L10n.appKey("settings.lockScreen.mediaPanelBackground.description", fallback: "Choose which background will be displayed when playing media."),
    ...
    private var widgetAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.lockScreen.widgetAppearance", fallback: "Widget appearance")) {
            CustomPicker(
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.lockScreen.mediaPanelPosition.title", fallback: "Media panel position"),
                description: L10n.appKey("settings.lockScreen.mediaPanelPosition.description", fallback: "Move the lock-screen media panel up or down."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.lockScreen.accentTint.title", fallback: "Accent tint"),
                description: L10n.appKey("settings.lockScreen.accentTint.description", fallback: "Blend the app accent color into the lock-screen widget background."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.lockScreen.backgroundBrightness.title", fallback: "Background brightness"),
                description: L10n.appKey("settings.lockScreen.backgroundBrightness.description", fallback: "Brighten or darken the widget background without changing the selected material style."),
        ...
        HStack(alignment: .center, spacing: 12) {
            ...
            HStack(spacing: 8) {
                if hasCustomSound(for: kind) {
                    Button(L10n.app("settings.lockScreen.customSound.reset", fallback: "Reset")) {
                ...
                Button(hasCustomSound(for: kind) ? L10n.app("settings.lockScreen.customSound.change", fallback: "Change") : L10n.app("settings.lockScreen.customSound.choose", fallback: "Choose")) {
