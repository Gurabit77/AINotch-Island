...
struct AboutAppSettingsView: View {
        ...
        ZStack {
            VStack(spacing: 15) {
                ...
                VStack(alignment: .center, spacing: 3) {
                    Text(L10n.app("settings.about.appName", fallback: "AINotchIsland"))
                        .font(.system(size: 18, weight: .semibold))
                        .accessibilityIdentifier("settings.about.title")

                    Text(L10n.app("settings.about.tagline", fallback: "Make the cutout area more useful."))
                        .font(.system(size: 10))
    ...
    private var highlightsCard: some View {
        VStack(spacing: 18) {
            AboutFeatureRow(
                title: L10n.appKey("settings.about.liveActivity.title", fallback: "Live Activity"),
                description: L10n.appKey("settings.about.liveActivity.description", fallback: "Persistent notch content stays visible for as long as the source event is active, then fades away when it ends."),
                notchWidth: 166,
                notchHeight: 26,
                topCornerRadius: 5,
            ...
            AboutFeatureRow(
                title: L10n.appKey("settings.about.temporaryActivity.title", fallback: "Temporary Activity"),
                description: L10n.appKey("settings.about.temporaryActivity.description", fallback: "Short-lived overlays appear above live activities so quick system events still feel prominent."),
                notchWidth: 166,
                notchHeight: 26,
                topCornerRadius: 5,
                bottomCornerRadius: 9,
            ...
            AboutFeatureRow(
                title: L10n.appKey("settings.about.lockScreen.title", fallback: "Lock Screen"),
                description: L10n.appKey("settings.about.lockScreen.description", fallback: "Carry notch context and media playback into the lock screen transition for a more cohesive experience."),
                notchWidth: 166,
                notchHeight: 26,
                topCornerRadius: 5,
                bottomCornerRadius: 9,
