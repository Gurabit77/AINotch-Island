...
struct NotchSettingsView: View {
    ...
    private var appearanceCard: some View {
        SettingsCard(title: L10n.appKey("settings.notch.appearance", fallback: "Notch appearance")) {
            CustomPicker(
                selection: $applicationSettings.notchBackgroundStyle,
                options: NotchBackgroundStyle.availableOptions,
                title: { $0.title },
                headerTitle: L10n.appKey("settings.notch.background.title", fallback: "Background"),
                headerDescription: L10n.appKey("settings.notch.background.description", fallback: "Choose the background color used across the notch."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.showStroke.title", fallback: "Show notch stroke"),
                description: L10n.appKey("settings.notch.showStroke.description", fallback: "Show a subtle outline that adapts to the active content color."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.defaultStrokeColor.title", fallback: "Use default activity stroke color"),
                description: L10n.appKey("settings.notch.defaultStrokeColor.description", fallback: "Apply the standard white stroke to supported activities instead of feature accent colors."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.notch.strokeWidth.title", fallback: "Stroke width"),
                description: L10n.appKey("settings.notch.strokeWidth.description", fallback: "Adjust the thickness of the notch outline."),
                range: 1...3,
                step: 0.5,
                fractionLength: 1,
                suffix: "px",
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.notch.notchWidth.title", fallback: "Notch width"),
                description: L10n.appKey("settings.notch.notchWidth.description", fallback: "Fine-tune the notch width to better match your display cutout."),
                range: -32...16,
                step: 1,
                fractionLength: 0,
                suffix: "px",
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.notch.notchHeight.title", fallback: "Notch height"),
                description: L10n.appKey("settings.notch.notchHeight.description", fallback: "Fine-tune the notch height to better match your display cutout."),
                range: -4...4,
                step: 1,
                fractionLength: 0,
                suffix: "px",
    ...
    private var animationCard: some View {
        SettingsCard(title: L10n.appKey("settings.notch.animation", fallback: "Animation")) {
            CustomPicker(
                selection: $applicationSettings.notchAnimationPreset,
                options: Array(NotchAnimationPreset.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.notch.animationSpeed.title", fallback: "Animation speed"),
                headerDescription: L10n.appKey("settings.notch.animationSpeed.description", fallback: "Set a global motion parameter that controls the speed of the animation."),
    ...
    private var gesturesCard: some View {
        SettingsCard(title: L10n.appKey("settings.notch.gestures", fallback: "Gestures")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.expandActivity.title", fallback: "Expand live activity"),
                description: L10n.appKey("settings.notch.expandActivity.description", fallback: "Allow the selected notch gesture to open the expanded live activity layout when supported."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.notch.expandGesture.title", fallback: "Expand gesture"),
                description: L10n.appKey("settings.notch.expandGesture.description", fallback: "Choose whether expanded content opens on click, after holding the notch, or after hovering over it."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.notch.pressHoldTiming.title", fallback: "Press and hold timing"),
                description: L10n.appKey("settings.notch.pressHoldTiming.description", fallback: "Adjust how quickly press-and-hold and hover expansion trigger."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.mouseDrag.title", fallback: "Mouse drag gestures"),
                description: L10n.appKey("settings.notch.mouseDrag.description", fallback: "Use click-and-drag over the notch to preview dismiss and restore interactions."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.trackpadSwipe.title", fallback: "Trackpad swipe gestures"),
                description: L10n.appKey("settings.notch.trackpadSwipe.description", fallback: "Use vertical two-finger scrolling over the notch to dismiss or restore the latest activity."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.swipeUpDismiss.title", fallback: "Swipe up to dismiss"),
                description: L10n.appKey("settings.notch.swipeUpDismiss.description", fallback: "Allow gestures to hide the currently visible live or temporary activity."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.notch.swipeDownRestore.title", fallback: "Swipe down to restore"),
                description: L10n.appKey("settings.notch.swipeDownRestore.description", fallback: "Allow gestures to bring back the most recently dismissed activity."),
