...
enum AINotchIslandLanguage: String, CaseIterable, Identifiable {
    case system
    case english = "en"
    case russian = "ru"
    case spanish = "es"
    ...
    static func resolved(_ rawValue: String?) -> AINotchIslandLanguage {
        guard let rawValue, let language = AINotchIslandLanguage(rawValue: rawValue) else {
            return .system
        }
