enum GeneralSettingsStorage {
    enum Keys {
        ...
        // Agent Halo
        static let agentHaloLayoutMode = "settings.agentHalo.layoutMode"
        static let agentHaloBypassPermissions = "settings.agentHalo.bypassPermissions"
        static let agentHaloAutoMode = "settings.agentHalo.autoMode"
        static let agentHaloSmartSuppression = "settings.agentHalo.smartSuppression"
        static let agentHaloIdleCleanupTimeout = "settings.agentHalo.idleCleanupTimeout"
    }
    ...
    static let defaultValues: [String: Any] = [
        ...
        Keys.appLanguage: AINotchIslandLanguage.system.rawValue,
        ...
        Keys.notchExpandInteraction: NotchExpandInteraction.hover.rawValue,
        ...
        Keys.agentHaloLayoutMode: AgentHaloLayoutMode.clean.rawValue,
        Keys.agentHaloBypassPermissions: false,
        Keys.agentHaloAutoMode: false,
        Keys.agentHaloSmartSuppression: true,
        Keys.agentHaloIdleCleanupTimeout: 7200
    ]
}
