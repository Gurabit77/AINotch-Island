...
struct NowPlayingSettingsView: View {
    ...
    private var playbackActivity: some View {
        SettingsCard(title: L10n.appKey("settings.nowPlaying.activity", fallback: "Playback activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.liveActivity.title", fallback: "Now Playing live activity"),
                description: L10n.appKey("settings.nowPlaying.liveActivity.description", fallback: "Show the Now Playing live activity while audio or video playback is active."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.nowPlaying.source.title", fallback: "Playback source"),
                description: L10n.appKey("settings.nowPlaying.source.description", fallback: "Choose which media app can show Now Playing in the notch."),
    ...
    private var pausedPlaybackBehavior: some View {
        SettingsCard(title: L10n.appKey("settings.nowPlaying.paused", fallback: "Paused playback")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.withoutCloseTimer.title", fallback: "Without close timer"),
                description: L10n.appKey("settings.nowPlaying.withoutCloseTimer.description", fallback: "Keep Now Playing visible in the notch while playback is paused."),
            ...
            SettingsSliderRow(
                title: L10n.appKey("settings.nowPlaying.closeDelay.title", fallback: "Close delay"),
                description: L10n.appKey("settings.nowPlaying.closeDelay.description", fallback: "Choose how long the paused player stays visible before the notch closes."),
    ...
    private var playerAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.nowPlaying.playerAppearance", fallback: "Player appearance")) {
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.artwork3D.title", fallback: "Artwork 3D effect"),
                description: L10n.appKey("settings.nowPlaying.artwork3D.description", fallback: "Animate artwork with a 3D flip when the track cover changes."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.hideFavorite.title", fallback: "Hide favorite"),
                description: L10n.appKey("settings.nowPlaying.hideFavorite.description", fallback: "Remove the favorite button from the expanded player controls."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.hideOutputDevice.title", fallback: "Hide output device"),
                description: L10n.appKey("settings.nowPlaying.hideOutputDevice.description", fallback: "Remove the output device button from the expanded player controls."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.nowPlaying.artworkTintedProgress.title", fallback: "Artwork-tinted progress"),
                description: L10n.appKey("settings.nowPlaying.artworkTintedProgress.description", fallback: "Color the progress bar and timer labels using the current artwork palette."),
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.nowPlaying.artworkTintedStroke.title", fallback: "Artwork-tinted stroke"),
                description: L10n.appKey("settings.nowPlaying.artworkTintedStroke.description", fallback: "Color the notch stroke using the current artwork palette."),
