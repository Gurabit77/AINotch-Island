...
struct DownloadsSettingsView: View {
    ...
    private var downloadActivity: some View {
        SettingsCard(title: L10n.appKey("settings.downloads.activity", fallback: "Download activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.downloads.liveActivity.title", fallback: "Downloads live activity"),
                description: L10n.appKey("settings.downloads.liveActivity.description", fallback: "Show a live activity while files are being downloaded to monitored folders like Downloads, Desktop, and Documents."),
    ...
    private var downloadAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.downloads.appearance", fallback: "Download appearance")) {
            CustomPicker(
                selection: $mediaSettings.downloadsAppearanceStyle,
                options: Array(DownloadAppearanceStyle.allCases),
                title: { $0.title },
                headerTitle: L10n.appKey("settings.downloads.style.title", fallback: "Download style"),
                headerDescription: L10n.appKey("settings.downloads.style.description", fallback: "Choose how much information the download activity shows at a glance."),
                itemHeight: 82,
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.downloads.progressIndicator.title", fallback: "Progress indicator"),
                description: L10n.appKey("settings.downloads.progressIndicator.description", fallback: "Choose whether download progress uses a percentage label or a circular ring."),
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.downloads.defaultStroke.title", fallback: "Default stroke"),
                description: L10n.appKey("settings.downloads.defaultStroke.description", fallback: "Use the standard white notch stroke instead of the accent-colored download stroke."),
