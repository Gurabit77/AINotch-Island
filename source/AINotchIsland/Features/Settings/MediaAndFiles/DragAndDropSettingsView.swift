...
struct DragAndDropSettingsView: View {
    ...
    private var dragAndDropActivity: some View {
        SettingsCard(title: L10n.appKey("settings.dragDrop.activity", fallback: "Drag&Drop activity")) {
            SettingsToggleRow(
                title: L10n.appKey("settings.dragDrop.liveActivity.title", fallback: "Drag&Drop live activity"),
                description: L10n.appKey("settings.dragDrop.liveActivity.description", fallback: "Show AirDrop, Tray, and File Converter targets when you drag files over the notch."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.dragDrop.trayLiveActivity.title", fallback: "Tray live activity"),
                description: L10n.appKey("settings.dragDrop.trayLiveActivity.description", fallback: "Show the pinned file tray after files are dropped into Tray."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.dragDrop.converterLiveActivity.title", fallback: "File Converter live activity"),
                description: L10n.appKey("settings.dragDrop.converterLiveActivity.description", fallback: "Show the File Converter live activity after a file is dropped for conversion."),
    ...
    private var dragAndDropMode: some View {
        SettingsCard(title: L10n.appKey("settings.dragDrop.target", fallback: "Drag&Drop target")) {
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.targetMode.title", fallback: "Target mode"),
                description: L10n.appKey("settings.dragDrop.targetMode.description", fallback: "Choose which target appears while files are dragged over the notch."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.targetColors.title", fallback: "Target colors"),
                description: L10n.appKey("settings.dragDrop.targetColors.description", fallback: "Choose how Drag&Drop target zones are colored."),
            ...
            SettingsStrokeToggleRow(
                title: L10n.appKey("settings.dragDrop.defaultStroke.title", fallback: "Default stroke"),
                description: L10n.appKey("settings.dragDrop.defaultStroke.description", fallback: "Use the standard white notch stroke instead of the Drag&Drop accent stroke."),
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.dragDrop.motionAnimation.title", fallback: "Motion animation"),
                description: L10n.appKey("settings.dragDrop.motionAnimation.description", fallback: "Play animation of cell movement when hovering a file over an area."),
    ...
    private var trayAppearance: some View {
        SettingsCard(title: L10n.appKey("settings.dragDrop.trayAppearance", fallback: "Tray appearance")) {
            SettingsNotchPreview(
                width: 430,
                height: 148,
                previewHeight: 166,
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.scrollDirection.title", fallback: "Scroll direction"),
                description: L10n.appKey("settings.dragDrop.scrollDirection.description", fallback: "Choose how files scroll inside the expanded Tray."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.trayUsage.title", fallback: "Tray usage"),
                description: L10n.appKey("settings.dragDrop.trayUsage.description", fallback: "Choose whether Tray keeps file copies or moves originals into Tray storage."),
            ...
            if mediaSettings.fileTrayUsageMode == .moveOriginals {
                HStack {
                    ...
                    Text(L10n.app("settings.dragDrop.trayUsage.warning", fallback: "If the original is moved to the tray and deleted from there, you can restore it in the system trash."))
                        .font(.system(size: 10))
            ...
            SettingsToggleRow(
                title: L10n.appKey("settings.dragDrop.hideRemoveButton.title", fallback: "Hide remove button"),
                description: L10n.appKey("settings.dragDrop.hideRemoveButton.description", fallback: "Hide the x button on file cards in the expanded Tray."),
    ...
    private var fileConverterFiles: some View {
        SettingsCard(title: L10n.appKey("settings.dragDrop.converterFiles", fallback: "File Converter files")) {
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.outputLocation.title", fallback: "Output location"),
                description: L10n.appKey("settings.dragDrop.outputLocation.description", fallback: "Choose where converted files are saved."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.existingFiles.title", fallback: "Existing files"),
                description: L10n.appKey("settings.dragDrop.existingFiles.description", fallback: "Choose what happens when a converted filename already exists."),
            ...
            SettingsTextFieldRow(
                title: L10n.appKey("settings.dragDrop.filenameSuffix.title", fallback: "Filename suffix"),
                description: L10n.appKey("settings.dragDrop.filenameSuffix.description", fallback: "Add this suffix before the converted file extension."),
    ...
    private var fileConverterQuality: some View {
        SettingsCard(title: L10n.appKey("settings.dragDrop.converterQuality", fallback: "File Converter quality")) {
            SettingsSliderRow(
                title: L10n.appKey("settings.dragDrop.imageQuality.title", fallback: "Image quality"),
                description: L10n.appKey("settings.dragDrop.imageQuality.description", fallback: "Used for lossy image formats like JPEG, HEIC, WEBP, and AVIF."),
                range: 10...100,
                step: 1,
                fractionLength: 0,
                suffix: "%",
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.videoQuality.title", fallback: "Video quality"),
                description: L10n.appKey("settings.dragDrop.videoQuality.description", fallback: "Choose the export preset used for video conversion."),
            ...
            SettingsMenuRow(
                title: L10n.appKey("settings.dragDrop.audioQuality.title", fallback: "Audio quality"),
                description: L10n.appKey("settings.dragDrop.audioQuality.description", fallback: "Choose the bitrate target for compressed audio formats."),
